...
{
    public partial class InitialAddPlacePhoto : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlacePhotoId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlacePhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlacePhotos_PlacePhotos_PlacePhotoId",
                        column: x => x.PlacePhotoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlacePhotos_PlacePhotoId",
                table: "PlacePhotos",
                column: "PlacePhotoId");
